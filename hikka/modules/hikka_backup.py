...
class HikkaBackupMod(loader.Module):
    ...
    strings_ua = {
        "period": (
            "⌚️ <b>Юніт «ALPHA»</b> створює регулярні резервні копії. Ці налаштування"
            " можна змінити пізніше.\n\nБудь ласка, виберіть періодичність резервного"
            " копіювання"
        ),
        "saved": (
            "✅ Періодичність збережено! Її можна змінити за допомогою .set_backup_period"
        ),
        "never": (
            "✅ Я не робитиму автоматичні резервні копії. Можна скасувати"
            " використовуючи .set_backup_period"
        ),
        "invalid_args": (
            "🚫 <b>Вкажи правильну періодичність в часах, або `0` для відключення</b>"
        ),
    }
