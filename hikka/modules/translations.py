...
class Translations(loader.Module):
    ...
    strings_ua = {
        ...
        "pack_saved": (
            "<emoji document_id=5368324170671202286>👍</emoji> <b>Пакет перекладів"
            " збережен!</b>"
        ),
        "incorrect_language": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Вказано невірну"
            " мову</b>"
        ),
        "lang_removed": (
            "<emoji document_id=5368324170671202286>👍</emoji> <b>Переклади скинуто"
            " на стандартні</b>"
        ),
        "check_pack": (
        ...
        "check_url": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Ви повинні вказати"
        ...
        "inline403": "🚫 <b>Ви не можете надсилати вбудовані елементи в цьому чаті</b>",
        "invoke_failed": "<b>🚫 Виклик модуля не вдався! Детальніше у логах</b>",
        "show_inline_cmds": "📄 Показати всі доступні вбудовані команди",
        "no_inline_cmds": "У вас немає доступних inline команд",
        "no_inline_cmds_msg": (
            "<b>😔 Щоб використати команди вам потрібно зробити <b>👾<a"
            ' href="https://github.com/timtimatim/amoggg">Bampi</a></b></b>"
        ),
        "inline_cmds": "ℹ️ У вас {} доступная(-ых) команда(-ы)",
        "inline_cmds_msg": "<b>ℹ️ Доступные inline команды:</b>\n\n{}",
        "run_command": "🏌️ Выполнить команду",
