...
class HikkaConfigMod(loader.Module):
    ...
    strings_ru = {
        ...
        "_cls_doc": "Интерактивный конфигуратор Bampi",
    ...
    strings_ua = {
        ...
        "configure": "🎚 <b>Виберіть модуль для налаштування</b>",
        "configure_lib": "🪴 <b>Виберіть бібліотеку для налаштування</b>",
        "configuring_mod": (
            "🎚 <b>Виберіть параметр для модуля</b> <code>{}</code>\n\n<b>Поточні"
            " налаштування:</b>\n\n{}"
        ),
        "configuring_lib": (
            "🪴 <b>Виберіть параметр для бібліотеки</b> <code>{}</code>\n\n<b>Поточні"
            " налаштування:</b>\n\n{}"
        ),
        "configuring_option": (
        ...
        "option_reset": (
            "♻️ <b>Параметр </b><code>{}</code><b> модуля </b><code>{}</code><b>"
            " скинуто до значення за умовчанням</b>\n<b>Поточне: {}</b>"
        ),
        "option_reset_lib": (
            "♻️ <b>Параметр </b><code>{}</code><b> бібліотеки </b><code>{}</code><b>"
            " сброшен до значения по умолчанию</b>\n<b>Поточне: {}</b>"
        ),
        "_cls_doc": "Інтерактивний конфігуратор Bampi",
        "args": "🚫 <b>Ти вказав невірні аргументи</b>",
        "no_mod": "🚫 <b>Модуль не існує</b>",
        "no_option": "🚫 <b>Модуль не має такого значення конфігу</b>",
        "validation_error": (
            "🚫 <b>Введено некоректне значення конфігу. \nОшибка: {}</b>"
        ),
        "try_again": "🔁 Спробувати ще раз",
        "typehint": "🕵️ <b>Повинно бути {}</b>",
        "set": "поставити",
        "set_default_btn": "♻️ Значення за замовчуванням",
        "enter_value_btn": "✍️ Ввести значення",
        "enter_value_desc": "✍️ Введіть нове значення цього параметра",
