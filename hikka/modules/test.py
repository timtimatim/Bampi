...
class TestMod(loader.Module):
    ...
    strings_ua = {
        "set_loglevel": "🚫 <b>Вкажи рівень логів числом чи рядком</b>",
        "no_logs": "ℹ️ <b>У тебе немає логів рівня {}.</b>",
        "logs_filename": "hikka-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>🌘</emoji> <b>Логи Bampi рівня"
            " </b><code>{}</code>\n\n<emoji document_id=5454390891466726015>👋</emoji>"
            " <b>Версія Bampi: {}.{}.{}</b>{}\n<emoji"
            " document_id=6321050180095313397>⏱</emoji> <b>Аптайм:"
            " {}</b>\n<b>{}</b>\n\n<b>{} NoNick</b>\n<b>{} Grep</b>\n<b>{}"
            " InlineLogs</b>"
        ),
        "bad_module": "🚫 <b>Модуль не знайдено</b>",
        "debugging_enabled": (
            "🧑‍💻 <b>Режим розробника увімкнено для модуля"
            " </b><code>{0}</code>\n<i>Вирушай у директорію `debug_modules`,"
            " змінюй файл `{0}.py`, і дивись зміни в режимі реального часу</i>"
        ),
        "debugging_disabled": "✅ <b>Режим розробника вимкнено</b>",
        "suspend_invalid_time": (
            "<emoji document_id=5416024721705673488>💀</emoji> <b>Невірний час"
            "заморозки</b>"
        ),
        "suspended": (
            "<emoji document_id=5452023368054216810>🥶</emoji> <b>Бот заморожений</b>"
            " <code>{}</code> <b>секунд</b>"
        ),
        "results_ping": (
            "<emoji document_id=5370869711888194012>👾</emoji><b>Bampi пінг: </b><code>"
            "</b><code>{}</code> <b>ms</b>\n<emoji"
            "</b><emoji document_id=5469741319330996757>💫</emoji><b>Аптайм:"
            " {}</b>"
        ),
        "ping_hint": (
            "<emoji document_id=5472146462362048818>💡</emoji> <i>Швидкість відгуку
            " Telegram більше залежить від завантаженості серверів Telegram і"
            "інших зовнішніх факторів і ніяк не пов'язана з параметрами сервера, на"
            "який встановлений юзербот</i>"
        ),
        "confidential": (
            "⚠️ <b>Рівень логів </b><code>{}</code><b> може містити особисту"
            "інформацію, будь обережний</b>"
        ),
        "confidential_text": (
            "⚠️ <b>Рівень логів </b><code>{0}</code><b> може містити особисту"
            "інформацію будь обережний</b>\n<b>Напиши </b><code>.logs {0}"
            " force_insecure</code><b>, щоб відправити логі ігноруючи"
            "попередження</b>"
        ),
        "choose_loglevel": "💁‍♂️ <b>Выбери уровень логов</b>",
        "_cmd_doc_dump": "Показать информацию о сообщении",
