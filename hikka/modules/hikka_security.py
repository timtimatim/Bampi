...
class HikkaSecurityMod(loader.Module):
    ...
    strings_ua = {
        ...
        "global": (
            "🔐 <b>Тут можна налаштувати глобальну маску, що виключає. Якщо тумблер"
            " вимкнений тут, він вимкнений для всіх команд</b>"
        ),
        "owner": "😎 Власник",
        "sudo": "🧐 Sudo",
        "support": "🤓 Помічник",
        ...
        "no_owner": (
            "<emoji document_id=5386399931378440814>😎</emoji> <b>Немає користувачів у"
            " групі </b><code>owner</code>"
        ),
        "no_sudo": (
            "<emoji document_id=5418133868475587618>🧐</emoji> <b>Немає користувачів у"
            " групі </b><code>sudo</code>"
        ),
        "no_support": (
            "<emoji document_id=5415729507128580146>🤓</emoji> <b>Немає користувачів у"
            " групі </b><code>support</code>"
        ),
        "no_user": (
        ...
        "not_a_user": (
            "<emoji document_id=5415905755406539934>🚫</emoji> <b>Вказана мета - не"
            " користувач</b>"
        ),
        "cancel": "🚫 скасувати",
        "confirm": "👑 Підтвердити",
        ...
        "warning": (
            '⚠️ <b>Ти дійсно хочеш додати <a href="tg://user?id={}">{}</a> у'
            " групу </b><code>{}</code><b>!\nЦя дія може передати частковий або"
            " повний доступ до користувача цьому користувачу!</b>"
        ),
        "suggest_nonick": (
            "🔰 <i>Чи хочеш ти увімкнути NoNick для цього користувача?</i>"
        ),
        "user_nn": '🔰 <b>NoNick для <a href="tg://user?id={}">{}</a> увімкнено</b>',
        "enable_nonick_btn": "🔰 увімкнути",
        "owner_added": (
            '<emoji document_id="5386399931378440814">😎</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> доданий до групи </b><code>owner</code>'
        ),
        "sudo_added": (
            '<emoji document_id="5418133868475587618">🧐</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> доданий до групи </b><code>sudo</code>'
        ),
        "support_added": (
            '<emoji document_id="5415729507128580146">🤓</emoji> <b><a'
            ' href="tg://user?id={}">{}</a> доданий до групи </b><code>support</code>'
        ),
        "owner_removed": (
            '<emoji document_id="5386399931378440814">😎</emoji> <b><a'
        ...
        "_cls_doc": "Управління налаштуваннями безпеки",
        "what": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Вам потрібно вказати"
            " тип мети першим аргументом (</b><code>user</code><b> or"
            " </b><code>chat</code><b>)</b>"
        ),
        "no_target": (
            "<emoji document_id=6053166094816905153>🚫</emoji> <b>Не вказана мета"
            " правила безпеки</b>"
        ),
        "no_rule": (
        ...
        "confirm_rule": (
            "🔐 <b>Будь ласка, підтвердіть, що хочете видати {} <a href='{}'>{}</a>"
            " право використовувати {} </b><code>{}</code><b> {}</b>"
        ),
        "multiple_rules": (
            "🔐 <b>Не вдалося однозначно розпізнати правила безпеки. Оберіть"
            " те, що мали на увазі:</b>\n\n{}"
        ),
        "rule_added": (
        ...
        "rules_removed": (
            "<emoji document_id=5472308992514464048>🔐</emoji> <b>Правила"
            ' таргетованої безпеки для <a href="{}">{}</a> видалені</b>'
        ),
        **service_strings_ua,
    }
