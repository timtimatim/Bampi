...
📣 <b>Check out community made channels with modules: <a href="https://t.me/BampiChat">show</a></b>
...
📣 <b>Загляни в каналы с модулями, созданными комьюнити: <a href="https://t.me/BampiChat">показать</a></b>
...
📣 <b>Заглянь у канали з модулями, створеними комьюніті: <a href="https://t.me/BampiChat">показати</a></b>
💁‍♀️ <b>Швидкий гайд:</b>
1️⃣ <b>Напиши </b><code>.help</code> <b>чтобы увидеть список модулей</b>
2️⃣ <b>Напиши </b><code>.help &lt;Название модуля/команда&gt;</code> <b>чтобы увидеть описание модуля</b>
3️⃣ <b>Напиши </b><code>.dlmod &lt;ссылка&gt;</code> <b>чтобы загрузить модуль из ссылка</b>
