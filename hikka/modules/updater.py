...
class UpdaterMod(loader.Module):
    ...
    strings_ru = {
        ...
        "restarting_caption": (
            "<emoji document_id=6318970114548958978>🕗</emoji> <b>Твой Bampi"
            " перезагружается...</b>"
        ),
        "downloading": (
        ...
        "full_success": (
            "<emoji document_id=6323332130579416910>👍</emoji> <b>Bampi полностью"
    ...
    strings_ua = {
        ...
        "restarting_caption": (
            "<emoji document_id=6318970114548958978>🕗</emoji> <b>Твій Bampi"
        ...
        "full_success": (
            "<emoji document_id=6323332130579416910>👍</emoji> <b>Bampi повністю"
            " завантажений! {}</b>\n<i>Повне перезавантаження зайняло {} сек</i>"
        ),
        "secure_boot_complete": (
            "🔒 <b>Безпечне завантаження завершено! {}</b>\n<i>Перезавантаження зайняло {}"
            " сек</i>"
        ),
        "origin_cfg_doc": "Посилання, з якого завантажуватиметься оновлення",
        "btn_restart": "🔄 Перезавантажити",
        "btn_update": "🧭 Оновитись",
        "restart_confirm": "❓ <b>Ти впевнений, що хочеш перезавантажити Bampi?</b>",
        "secure_boot_confirm": (
            "❓ <b>Ти впевнений, що"
            " хочеш перезавантажитись у режимі безпечного завантаження?</b>"
        ),
        "update_confirm": (
            "❓ <b>Ти впевнений, що"
            " хочеш оновитися??\n\n<a"
