...
class APIRatelimiterMod(loader.Module):
    ...
    strings_ua = {
        "warning": (
            "<emoji document_id=6319093650693293883>☣️</emoji>"
            " <b>ВНИМАНИЕ!</b>\n\nОбліковий запис надійшов за ліміти повернення, повернення в"
            "конфіг з метою запобігання флуду Telegram API, юзербот був"
            " <b>повністю заморожено</b> на {} секунд. додаткова інформація"
            "прикріплена у файлі нижче. \n\nРекомендується звернутися за допомогою до"
            ...
            " ресурсозатратну операцію, використовуй"
            " <code>{prefix}suspend_api_protect</code> &lt;час у секундах&gt;"
        ),
        "args_invalid": (
            "<emoji document_id=6319093650693293883>☣️</emoji> <b>Невірні"
            " аргументи</b>"
        ),
        "suspended_for": (
        ...
        "test": (
            "<emoji document_id=6319093650693293883>☣️</emoji> <b>Ця дія"
            " відкриває можливість флудити Telegram API.</b> <i>Для того,"
            " щоб переконатися, що ти справді впевнений у тому, що робиш - виріши"
            " простенький тест - знайди емодзи, що відрізняється.</i>"
        ),
        "on": "<emoji document_id=5458450833857322148>👌</emoji> <b>Захист включений</b>",
        "off": (
            "<emoji document_id=5458450833857322148>👌</emoji> <b>Захист вимкнено</b>"
        ),
        "u_sure": "<emoji document_id=6319093650693293883>☣️</emoji> <b>Ти впевнений?</b>",
        "_cfg_time_sample": (
            "Тимчасовий проміжок, за яким буде рахуватися кількість запитів"
        ),
        "_cfg_threshold": "Поріг запитів, при якому спрацьовуватиме захист",
        "_cfg_local_floodwait": (
