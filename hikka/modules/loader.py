...
class LoaderMod(loader.Module):
    ...
    strings_ua = {
        ...
        "preset_loaded": (
            "<emoji document_id=6323332130579416910>✅</emoji><b> Пресет завантажений</b>"
        ),
        "no_module": (
            "<emoji document_id=5375201396859607943>🚫</emoji><b> Модуль недоступний у"
            " репозитоії.</b>"
        ),
        "no_file": (
        ...
        "load_failed": (
            ...
            " увінчалася успіхом. Дивись логи.</b>"
        ),
        "loaded": (
            "<emoji document_id=5188377234380954537>🌘</emoji><b> Модуль"
            " </b><code>{}</code>{}<b> завантажений {}</b>{}{}{}{}{}{}"
        ),
        ...
        "requirements_failed_termux": (
            ...
            " залежностей</b>\n<b>Найчастіше виникає через те, що Termux не"
            " підтримує багато бібліотек. Не повідомляйте про це як помилку, це"
            " не може бути виправлено.</b>"
        ),
        "requirements_installing": (
        ...
        "requirements_restart": (
            ...
            " встановлені, але потрібне перезавантаження для застосування </b><code>{}</code>"
        ),
        "all_modules_deleted": (
            "<emoji document_id=6323332130579416910>✅</emoji><b> Модулі видалені</b>"
        ),
        "single_cmd": "\n▫️ <code>{}{}</code> {}",
        ...
        "version_incompatible": (
            ...
            " потрібно Bampi версії {}+\nОбновися за допомогою </b><code>.update</code>"
        ),
        "ffmpeg_required": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Цьому модулю"
            " потрібно FFMPEG, який не встановлено</b>"
        ),
        "developer": (
        ...
        "by": "от",
        "module_fs": (
            "💿 <b>Ти хочеш зберегти модуль на жорсткому диску, щоб він не вивантажувався"
        ...
        "will_save_fs": (
            "💽 Тепер всі модулі, завантажені з файлу, зберігатимуться на жорсткий"
            " диск"
        ),
        "inline_init_failed": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Цьому модулю потрібен"
            " BampiInline, а ініціалізація менеджера інлайну невдала</b>\n<i>Спробуй"
            " видалити одного зі старих ботів у @BotFather і перезавантажити юзербота</i>"
        ),
        "_cmd_doc_dlmod": "Завантажує та встановлює модуль з репозиторію",
        "_cmd_doc_dlpreset": "Завантажує та встановлює певний набір модулів",
        "_cmd_doc_loadmod": "Скачивает и устанавливает модуль из файла",
        ...
        "unsubscribed": "🚫 Я більше не пропонуватиму передплатити цей канал",
        "confirm_clearmodules": (
            "⚠️ <b>Ви впевнені, що хочете вивантажити всі модулі?</b>"
        ),
        "clearmodules": "🗑 Вивантажити модулі",
        "cancel": "🚫 скасування",
        "overwrite_module": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Цей модуль"
            " спробував перезаписати вбудований (</b><code>{}</code><b>)</b>\n\n<emoji"
            " document_id=5472146462362048818>💡</emoji><i> Це не помилка, а міра"
            " безпеки, потрібна для запобігання заміні вбудованих модулів"
            " всяким мотлохом. Не повідомляйте про неї у support чаті</i>"
        ),
        "overwrite_command": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Этот модуль"
            " спробував перезаписати вбудовану команду"
            " (</b><code>{}</code><b>)</b>\n\n<emoji"
            " document_id=5472146462362048818>💡</emoji><i> Це не помилка, а міра"
            " безпеки, потрібна для запобігання заміні вбудованих модулів"
            " всяким мотлохом. Не повідомляйте про неї у support чаті</i>"
        ...
        "unload_core": (
            ...
            " вивантажити вбудований модуль </b><code>{}</code><b></b>\n\n<emoji"
            " document_id=5472146462362048818>💡</emoji><i> Це не помилка, а міра"
            " безпеки, потрібна для запобігання заміні вбудованих модулів"
            " всяким мотлохом. Не повідомляйте про неї у support чаті</i>"
        ),
        "cannot_unload_lib": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Ти не можеш"
            " вивантажити бібліотеку</b>"
        ),
        "wait_channel_approve": (
            "<emoji document_id=5469741319330996757>💫</emoji> <b>Модуль"
            " </b><code>{}</code><b> запитує дозвіл на вступ до каналу <a"
            ' href="https://t.me/{}">{}</a>.\n\n<b><emoji'
            ' document_id="5467666648263564704">❓</emoji> Причина:'
