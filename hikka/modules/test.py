...
class TestMod(loader.Module):
    ...
    strings_ua = {
        ...
        "logs_filename": "Bampi-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>🌘</emoji> <b>Логі Bampi рівня"
            " </b><code>{}</code>\n\n<emoji document_id=5454390891466726015>👋</emoji>"
            " <b>Версія Bampi: {}.{}.{}</b>{}\n<emoji"
        ...
        "debugging_enabled": (
            ...
            " змінюй файл `{0}.py`, та дивись зміни в режимі реального часу</i>"
        ),
        ...
        "suspended": (
            "<emoji document_id=5452023368054216810>🥶</emoji> <b>Бот заморожений на</b>"
            " <code>{}</code> <b>секунд</b>"
        ),
        "results_ping": (
        ...
        "confidential_text": (
            ...
            " інформацію, будь обережний</b>\n<b>Напиши </b><code>.logs {0}"
            " force_insecure</code><b>, щоб відправити логи ігноруючи"
            " попередження</b>"
        ),
        "choose_loglevel": "💁‍♂️ <b>Вибери рівень логів</b>",
        "_cmd_doc_dump": "Показати інформацію про повідомлення",
        "_cmd_doc_logs": (
            "<рівень> - Надсилає лог-файл. Рівні нижче WARNING можуть містити"
            " особисту інформацію."
        ),
        "_cmd_doc_suspend": "<час> - Заморозити бота на деякий час.я",
